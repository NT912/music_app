...
function playTrack(trackIndex) {
  ...
  // Cập nhật thông tin bài hát đang phát ở footer
  currentTrackInfo.textContent = track.track_name + " - " + track.singer;

  // Cập nhật đường dẫn của bài hát cho thẻ audio
  audioSource.src = track.tracks_path;

  // Phát bài hát
  audioPlayer.play();

  // Thêm bài hát vào danh sách bài hát đang phát
  var playlist = document.getElementById("playlist");
  var li = document.createElement("li");
  li.textContent = track.track_name + " - " + track.singer;
