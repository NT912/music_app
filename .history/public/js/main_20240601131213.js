...
function playTrack(trackIndex) {
  ...
  var trackSources = document.querySelectorAll("#track-list audio source");

  // Kiểm tra xem có đủ phần tử trong danh sách bài hát hay không
  if (trackSources.length > trackIndex && trackSources[trackIndex]) {
    var trackPath = trackSources[trackIndex].src;

    // Tiếp tục xử lý như bình thường
  } else {
    console.error("Không tìm thấy bài hát tại chỉ mục", trackIndex);
  }
}
