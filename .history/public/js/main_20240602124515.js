...
let isRandom = false;
let isRepeat = false;
let playlist = []; // To store the playlist
let currentIndex = -1; // To track the current song index
...
// Event listener to close options menu when clicking outside
