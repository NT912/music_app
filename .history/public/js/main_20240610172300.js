...
function playCurrentTrack() {
  ...
  sidebarTracks[currentIndex].classList.add("current-track");
}
...
function playAudio(trackName, singer, trackPath) {
  ...
  currentPlayingIndex = playlist.findIndex(
    (track) => track.trackName === trackName && track.singer === singer
  );
}

function updateSidebarUI() {
  const playlistItems = document.querySelectorAll(".sidebar ul.playlist li");

  // Đặt kiểu in đậm cho thẻ bài hát đang phát
