...
function showDeleteConfirmation(trackName, singer, trackPath) {
  trackToDelete = { trackName, singer, trackPath };
...
document
  ...
  .addEventListener("click", function () {
    if (trackToDelete) {
      deleteTrack(trackToDelete.trackPath);
      closeDeleteConfirmation();
    }
  });

function deleteTrack(trackPath) {
  console.log("Deleting track with path:", trackPath);

  fetch(`/tracks/delete-song`, {
    method: "DELETE",
    headers: {
      "Content-Type": "application/json",
    },
