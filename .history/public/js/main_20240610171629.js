...
function playCurrentTrack() {
  ...
  highlightCurrentTrack(track.trackName);
}

function highlightCurrentTrack(trackName) {
  const sidebarTracks = document.querySelectorAll(".sidebar .playlist li");
  sidebarTracks.forEach((track) => {
    track.classList.remove("current-track");
    if (track.textContent.includes(trackName)) {
