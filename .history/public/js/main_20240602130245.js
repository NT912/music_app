...
function addToPlaylist(trackName, singer, trackPath, userId) {
  let track = { trackName, singer, trackPath, userId };
  if (!playlist.some((t) => t.trackPath === trackPath && t.userId === userId)) {
    playlist.push(track);
    updatePlaylistUI();
  }
}
